...
// ningún truco: basta con acercarles la posición. "reveal" y "cards" caen dentro de la salida
// de About2 a propósito — Services entra mientras About2 todavía se está retirando.
//
...
export const PHASE = {
  ...
  reveal: 1.45, // entra el título de Services
  aboutOut: 1.6, // About2 termina de abrirse; desde acá vira el color de fondo
  cards: 1.65, // arranca el abanico, un toque después del título
  end: 2.15, // el sobrante sobre "cards" es lo que dura el abanico: 0.5 = 50vh de rueda
} as const;
